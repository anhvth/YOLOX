...
from yolox.utils import (gather, get_local_rank, is_main_process, postprocess,
                         synchronize, time_synchronized, xyxy2xywh)
...
class COCOEvaluator:
    ...
    def get_prediction(self,
        ...
        if trt_file is not None:
            ...
            model(x)
            model = model_trt
        pbar = progress_bar(self.dataloader)
        np_imgs = 0
    ...
    def evaluate(
        ...
        Returns:
            ...
            summary (sr): summary info of evaluation.
        """
        data_list, statistics = self.get_prediction(model,
                                                    distributed=distributed,
                                                    half=half,
                                                    trt_file=trt_file,
                                                    decoder=decoder,
                                                    test_size=test_size, out_file=out_file)

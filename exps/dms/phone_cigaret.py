...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = "/data/DMS_Behavior_Detection/Mobile_Cigarret_DB"
        # name of annotation file for training
        self.train_ann = "mobile_cigarette_train_081522_finetuning.json"
        # name of annotation file for evaluation
        self.val_ann = "mobile_cigarette_val_080422.json"
        # name of annotation file for testing
        self.test_ann = "mobile_cigarette_val_080422.json"
